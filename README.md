...
add the files on your code editor (vsc , atom , sublime etc.)

or git clone 

```
git clone https://github.com/Mihaidev-cloud/openweather-react-app.git

```

after that make sure you install everything using  ``` npm install ```

after that just run it with ``` npm start ```
